...
"/home/mila/r/rygaards/proj/milabench/milabench/base/venv/torch/bin/milabench" run \
  ...
  --dash no \
  --noterm \
  --run-name "torchatari_p2_full_lock_validate_env16_mb8_20260422_132040" \
  --repeat 1 \
  --override torchatari.voir.options.stop=250

RUN_DIR="/home/mila/r/rygaards/proj/milabench/milabench/base/runs/torchatari_p2_full_lock_validate_env16_mb8_20260422_132040"
TB_ROOT="/home/mila/r/rygaards/proj/milabench/benchmarks/retired/torchatari/runs"
METRIC_JSON="/home/mila/r/rygaards/proj/milabench/brdg-hackathon/sessions/torchatari/1/codex/artifacts/benchmarks/torchatari_p2_full_lock_validate_env16_mb8_20260422_132040.metrics.json"
