...
"/home/mila/r/rygaards/proj/milabench/milabench/base/venv/torch/bin/milabench" run \
  ...
  --dash no \
  --noterm \
  --run-name "torchatari_p2_short_hp_env16_mb8q_20260422_131228" \
  --repeat 1 \
  --override torchatari.voir.options.stop=65 --override torchatari.argv."--num-envs"=16 --override torchatari.argv."--num-minibatches"=8

RUN_DIR="/home/mila/r/rygaards/proj/milabench/milabench/base/runs/torchatari_p2_short_hp_env16_mb8q_20260422_131228"
TB_ROOT="/home/mila/r/rygaards/proj/milabench/benchmarks/retired/torchatari/runs"
METRIC_JSON="/home/mila/r/rygaards/proj/milabench/brdg-hackathon/sessions/torchatari/1/codex/artifacts/benchmarks/torchatari_p2_short_hp_env16_mb8q_20260422_131228.metrics.json"
