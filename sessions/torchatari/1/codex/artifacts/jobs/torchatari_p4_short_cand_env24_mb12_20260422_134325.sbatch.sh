...
"/home/mila/r/rygaards/proj/milabench/milabench/base/venv/torch/bin/milabench" run \
  --base milabench/base \
  --config "brdg-hackathon/sessions/torchatari/1/codex/artifacts/tmp/dev_env24_mb12.yaml" \
  --select torchatari \
  --use-current-env \
  --no-report \
  --dash no \
  --noterm \
  --run-name "torchatari_p4_short_cand_env24_mb12_20260422_134325" \
  --repeat 1 \
  --override torchatari.voir.options.stop=65

RUN_DIR="/home/mila/r/rygaards/proj/milabench/milabench/base/runs/torchatari_p4_short_cand_env24_mb12_20260422_134325"
TB_ROOT="/home/mila/r/rygaards/proj/milabench/benchmarks/retired/torchatari/runs"
METRIC_JSON="/home/mila/r/rygaards/proj/milabench/brdg-hackathon/sessions/torchatari/1/codex/artifacts/benchmarks/torchatari_p4_short_cand_env24_mb12_20260422_134325.metrics.json"
