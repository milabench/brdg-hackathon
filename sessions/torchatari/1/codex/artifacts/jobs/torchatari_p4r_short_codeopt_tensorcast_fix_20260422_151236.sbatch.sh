...
"/home/mila/r/rygaards/proj/milabench/milabench/base/venv/torch/bin/milabench" run \
  --base milabench/base \
  --config "brdg-hackathon/sessions/torchatari/1/codex/artifacts/tmp/dev_env32_mb16.yaml" \
  --select torchatari \
  --use-current-env \
  --no-report \
  --dash no \
  --noterm \
  --run-name "torchatari_p4r_short_codeopt_tensorcast_fix_20260422_151236" \
  --repeat 1 \
  --override torchatari.voir.options.stop=65

RUN_DIR="/home/mila/r/rygaards/proj/milabench/milabench/base/runs/torchatari_p4r_short_codeopt_tensorcast_fix_20260422_151236"
TB_ROOT="/home/mila/r/rygaards/proj/milabench/benchmarks/retired/torchatari/runs"
METRIC_JSON="/home/mila/r/rygaards/proj/milabench/brdg-hackathon/sessions/torchatari/1/codex/artifacts/benchmarks/torchatari_p4r_short_codeopt_tensorcast_fix_20260422_151236.metrics.json"
