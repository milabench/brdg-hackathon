...
#SBATCH -c 6
#SBATCH --job-name=torchatari_c1t2s2
#SBATCH --output=/home/mila/r/rygaards/proj/milabench/brdg-hackathon/sessions/torchatari/2/sonnet4.6/phase3_c1_uint8_t2_s2.out
...
echo "=== Phase 3 C1 uint8 Tier-2 seed 2 ==="
